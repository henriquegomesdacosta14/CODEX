"""
IQBOT Gale Watchdog v1.0
Monitora o bot_gale.py e reinicia automaticamente se travar.
"""
import subprocess, time, sys, os, socket
from datetime import datetime

BOT_FILE    = os.path.join(os.path.dirname(os.path.abspath(__file__)), "bot_gale.py")
CHECK_PORT  = 8765
MAX_TRAVADO = 60
RESTART_WAIT= 5
